...
export function Footer() {
  return (
    ...
    >
      <nav
        aria-label="Footer"
        className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:grid-cols-2 md:grid-cols-4 md:px-8 lg:py-16"
      >
          ...
          <div className="mt-2 flex flex-wrap gap-3">
            {socialLinks.map(({ icon: Icon, href, label }) => (
              <a
                ...
                aria-label={label}
                className="rounded-full bg-white/10 p-2 transition-colors hover:bg-white/20 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--mdw-footer-bg)]"
              >
